					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div>
							<form action="update.php" method="GET">
								<input class="form-control border-0" type="text" name="text" value="<?php echo $stroka["text"]?>">
								<input type="text" name="img" value="<?php echo $stroka["img"]; ?>" style="display: none;">
								<input type="text" name="user" value="<?php echo $stroka["user"]; ?>" style="display: none;">
								<input type="text" name="id" value="<?php echo $stroka["id"]; ?>" style="display: none;">
						...
						<div class="row">
							...
							<form action="delete.php" method="GET"> 
								<input type="text" name="iddelete" value="<?php echo $stroka["id"]; ?>" style="display: none;">
